const TRACKER = 'Tracker1'; //Tracker name
const REGION = "ap-south-1";
const IDENTITY_POOL_ID = "ap-south-1:be32f55a-60b6-46f7-a87e-d33a2a1978f0";
const WEBSOCKET_URL = "wss://zxzn9hnhk2.execute-api.ap-south-1.amazonaws.com/production/"; // This is of the form: wss://<id>.execute-api.<region>.amazonaws.com/<stage>
